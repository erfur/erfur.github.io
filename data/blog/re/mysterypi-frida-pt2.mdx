...
<div>![img](/static/images/mysterypi-frida-pt2/sdlfcntable.png)</div>
...
<video controls>
  <source src="/static/images/mysterypi-frida-pt2/zoomobject.mp4" type="video/mp4" />
</video>
...
<div>![img](/static/images/mysterypi-frida-pt2/parsegameobjects.png)</div>
...
<div>![img](/static/images/mysterypi-frida-pt2/hintclass.png)</div>
...
<video controls>
  <source src="/static/images/mysterypi-frida-pt2/resethint.mp4" type="video/mp4" />
</video>
...
<div>![img](/static/images/mysterypi-frida-pt2/executehint.png)</div>
...
<div>![img](/static/images/mysterypi-frida-pt2/hintpopup.png)</div>
...
class Hint {
  ...
  get activeSetInfo() {
    let fcn = new NativeFunction(ptr(0x00420260), 'pointer', ['pointer', 'pointer'], 'thiscall')
...
class Set {
  ...
  get infoBuf() {
    let fcn = new NativeFunction(ptr(0x004210c0), 'pointer', ['pointer', 'pointer'], 'thiscall')
  ...
  getImage(offset) {
    ...
    return new Image(fcn(this.infoBuf, rectBuf, offsetBuf).readPointer().add(16).readPointer())
  }
}
...
<video controls>
  <source src="/static/images/mysterypi-frida-pt2/unresponsive.mp4" type="video/mp4" />
</video>
...
<video controls>
  <source src="/static/images/mysterypi-frida-pt2/solve.mp4" type="video/mp4" />
</video>
...
<video controls>
  <source src="/static/images/mysterypi-frida-pt2/solve2.mp4" type="video/mp4" />
</video>
...
<video controls>
  <source src="/static/images/mysterypi-frida-pt2/complete.mp4" type="video/mp4" />
</video>
