...
{% include aligner.html images="/tplink-rce/strcpy1.png" width=70 %}

From [mozilla developer page]:

{% include aligner.html images="/tplink-rce/multipart1.png" width=80 %}
...
{% include aligner.html images="/tplink-rce/auth1.png" width=60 %}
...
{% include aligner.html images="/tplink-rce/dos1.png" width=70 %}

In the code that parses `Cookie` headers, there is a function that parses and
sets pointers to name and value pairs.

{% include aligner.html images="/tplink-rce/dos2.png" width=70 %}
...
{% include aligner.html images="/tplink-rce/args1.png" width=50 %}
...
{% include aligner.html images="/tplink-rce/args2.png" width=65 %}
...
{% include aligner.html images="/tplink-rce/linkedlist1.svg" width=40 %}
...
{% include aligner.html images="/tplink-rce/args3.png" width=50 %}
...
{% include aligner.html images="/tplink-rce/payload.svg" width=45 %}
...
{% include video.html source="/tplink-rce/exploit.mp4" %}
